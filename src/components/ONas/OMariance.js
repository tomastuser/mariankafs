  ...
  return (
    <div className='mainTextCont'>
      <div className='mainText'>
        ...
        <ul>
          <li>
            pravidelné <b>celoroční předškolní vzdělávání</b> pro skupinku dětí
            ve věku 3−7 let (max. 15 dětí)
          </li>
          <li>
          ...
          <li>
            program realizujeme převážně <b> v přírodě „bez zdí a plotů“ </b> za
            přítomnosti dvou pedagogů
          </li>
          <li>
            {' '}
