  ...
  return (
    <div className='mainTextCont'>
      <div className='mainText'>
        <h1>Zápis</h1>
        <p>
          Do naší lesní mateřské školy jsou přijímány děti ve věku 3 - 6 let do
          maximální kapacity 15 dětí.
        </p>
        ...
        <ol>
          ...
          <li>
            ...
            zápisu, který se každoročně koná 1. týden v květnu (konkrétní termín
            sledujte na webu či FB)
          </li>
          <li>do konce května dostanete rozhodnutí o přijetí</li>
        </ol>
        <p>
          <br />
          Aktuální termíny Dne otevřených dveří i zápisu najdete na našem webu a
          FB. <br />
          Chcete-li vaše dítě přihlásit v průběhu školního roku, informujte se u
          zástupkyně ředitelky o volných místech. <br />
          ...
          Upozorňujeme, že LMŠ Mariánka přijímá děti, které jsou řádně očkované
          (rodiče dodají potvrzení od lékaře, nebo potvrzení o zdravotní
          kontraindikaci podle § 50 zák. č. 258/2000 Sb. o ochraně veřejného
          zdraví).
          <br /> Informace k poplatkům za vzdělávání najdete v záložce Pro
          rodiče. <br />
          Na přijetí dítěte do LMŠ Mariánka není nárok. O přijetí dětí rozhoduje
          ředitelka LMŠ podle stanovených kritérií. <br />
          ...
          pravidelně pořádá zřizovatel spolek Kavyl z.s. Kroužek probíhá jednou
          týdně v zázemí LMŠ Mariánka a je určený pro děti 1 - 3 roků s
          doprovodem. Více na webu spolku Kavyl{' '}
          <a href='www.lesnikavyl.cz'>www.lesnikavyl.cz.</a>
          <br />V případě dotazů můžete zavolat nebo napsat zástupkyni ředitelky
          LMŠ Kláře Taufarové: <br />
